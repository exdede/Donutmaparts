...
public class DonutMapartsMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // via KeyBinding.Category.create, so create it exactly once here.
        ...
        ItemTooltipCallback.EVENT.register((stack, tooltipContext, tooltipType, lines) -> {
            ...
            lines.add(Text.literal("Map #" + mapId.id() + " " + (state == null ? "untracked" : state)));
            Integer pos = MapCaptureTracker.INSTANCE.queue().queuePositionOf(mapId.id());
            if (pos != null) lines.add(Text.literal("Queue position: " + pos));
        });
    }
